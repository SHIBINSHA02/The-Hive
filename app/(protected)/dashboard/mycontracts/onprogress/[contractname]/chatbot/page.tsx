                    ...
                    <div className="mt-4 space-y-4">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <span
                                    className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${finance.paymentStatus === "completed"
                                ...
                                <ul className="space-y-3">
                                    {finance.milestones.map((m, idx) => (
                                        ...
                                        >
                                            ...
                                            <span
                                                className={`px-2.5 py-1 rounded-full text-xs font-medium ${m.isPaid ? "bg-blue-100 text-blue-800" : "bg-blue-700 text-white"
                                                    }`}
                                            >
