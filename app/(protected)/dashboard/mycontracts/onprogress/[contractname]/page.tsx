...
export default function OnProgressContractDetailsPage() {
  ...
  const [chatMessages, setChatMessages] = useState<{ role: "user" | "bot"; text: string }[]>([
    { role: "bot", text: "Hi! I'm your Hive Assistant. Ask me anything about this active contract." }
  ]);
    ...
    <div className="w-full lg:px-6 px-0 lg:py-6 py-0 space-y-6 relative">
      ...
      <div className="relative w-full h-56 rounded-2xl overflow-hidden shadow flex flex-col justify-end group/bg">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-6 flex items-end justify-between text-white">
          ...
          <div className="flex items-center gap-3">
             <div className="bg-emerald-600/20 backdrop-blur-md text-emerald-400 px-4 py-2 rounded-lg font-bold border border-emerald-500/30 flex items-center gap-2 uppercase tracking-wider text-xs">
                Active Contract
             </div>
          </div>
        </div>
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-5 shadow">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-3">
          ...
          <Link
            href={`/dashboard/mycontracts/onprogress/${encodeURIComponent(contractId)}/conversation`}
