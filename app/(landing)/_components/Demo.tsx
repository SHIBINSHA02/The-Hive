...
export function Demo() {
    return (
        <section id="demo" className=" flex lg:w-1/2 lg:py-16 lg:rounded-b-4xl boarder-b-4  border-blue-300 lg:m-0 m-8">
            <div className="container lg:border  py-6 w-fit  lg:m-auto rounded-3xl  flex flex-col  items-center px-0 sm:px-6 lg:px-12 xl:px-20">
                ...
                <p className="text-center lg:text-4xl text-2xl font-semibold font-sans">Experience The Hive</p>
                ...
                <form className="mt-6 w-full lg:mx-auto space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row sm:space-x-3">
                        <input type="text" placeholder="First Name" className="border border-gray-400 rounded-md p-2 mb-4 w-full" />
                        <input type="text" placeholder="Last Name" className="border border-gray-400 rounded-md p-2 mb-4 w-full" />
                    </div>

                    {/* 2. Corrected: Single input is self-closed correctly with '/>' */}
                    <div className="flex flex-col">
                        <input type="email" placeholder="Enter your email *" className="border border-gray-400 rounded-md p-2 mb-4 w-full"  />
                    </div>

                    {/* 3. Corrected: Single input is self-closed correctly with '/>' */}
                    <div className="flex flex-col">
                        <input type="text" placeholder="Business Name" className="border border-gray-400 rounded-md p-2 mb-4 w-full"  />
                    </div>
                    ...
                    <div className="flex flex-col">
                        <textarea placeholder="Additional Message" className="border border-gray-400 rounded-md p-2 mb-4 w-full"></textarea>
                    </div>
