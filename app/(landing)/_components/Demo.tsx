...
export function Demo() {
    return (
        <section id="demo" className="bg-white flex items-center py-16 rounded-b-[80px] m:rounded-b-4xl boarder-b-4 border-blue-300">
            <div className="container flex flex-col justify-center items-centermx-auto px-4 sm:px-6 lg:px-12 xl:px-20">
                ...
                <p className="text-center mx-auto p-3 text-gray-500 w-[400px] mt-2">Sign up now for instant access to our advanced dental AI solutions.</p>
                <form className="mt-6 max-w-lg mx-auto space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row sm:space-x-4">
                        <input type="text" placeholder="First Name" className="border rounded-md p-2 mb-4 w-full" value="" />
                        <input type="text" placeholder="Last Name" className="border rounded-md p-2 mb-4 w-full" value="" />
                    </div>

                    {/* 2. Corrected: Single input is self-closed correctly with '/>' */}
                    <div className="flex flex-col">
                        <input type="email" placeholder="Enter your email *" className="border rounded-md p-2 mb-4 w-full" value="" />
                    </div>

                    {/* 3. Corrected: Single input is self-closed correctly with '/>' */}
                    <div className="flex flex-col">
                        <input type="text" placeholder="Business Name" className="border rounded-md p-2 mb-4 w-full" value="" />
                    </div>
