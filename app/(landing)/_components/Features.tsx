...
export default function Features() {
  ...
  return (
    <section id="features" className="bg-gradient-to-br from-blue-50 via-blue-50 to-blue-200 min-h-screen flex items-center py-16 lg:rounded-t-4xl boarder-t-4 border-blue-300">
